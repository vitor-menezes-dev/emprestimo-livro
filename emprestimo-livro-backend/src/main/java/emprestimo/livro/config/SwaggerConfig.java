...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("emprestimo.livro.resources")).paths(PathSelectors.any())
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Emprestimo Livros",
				"Esta API é utilizada para acesso das informações do Emprestimo Livros", "Versão 1.0",
				"",
				new Contact("Vítor Andrade Menezes de Sousa", "", "vitor.menezes.dev@gmail.com"),
